                                        ...
                                        <tr key={company.id}>
                                                ...
                                                <div className="flex items-center">
                                                    <div className="flex-shrink-0 h-10 w-10">
                                                        <img className="h-10 w-10 rounded-full"
                                                             src={company.logo ? company.logo : 'https://via.placeholder.com/150'}
                                                             alt=""/>
                                                    </div>
                                                    <div className="ml-4">
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <a href="#" className="text-indigo-600 hover:text-indigo-900 mr-4"
                                                   onClick={(e) => {
                                                       e.preventDefault();
                                                       Inertia.post(route('artist.edit', company.id))
                                                   }}>Edytuj</a>
                                                <a href="#" className="text-red-600 hover:text-indigo-900"
                                                   onClick={(e) => {
                                                       e.preventDefault();
                                                       Inertia.delete(route('artist.destroy', company.id))
                                                   }}>Usuń</a>
                                            </td>
                                        </tr>
                                    ))}
